...
dat_path = os.path.join(od_path, "Work\\P_curve_shape\\version2\\dat\\simulation_results\\results_ALLEE_theta")

# path to output fitted data
data_fits_path = os.path.join(dat_path, "..", "data_fits_ALLEE_THETA.csv")
